...
-- INITIAL DATA
-- ─────────────────────────────────────────────────────────────────────────
-- Seed with OpenAI as INACTIVE - admin must add real key and activate
...
INSERT INTO ai_settings (
  ...
  'openai',
  'ChatGPT',
  'sk-placeholder-configure-in-admin',
  'gpt-4.1',
  FALSE,
  'Primary AI provider for editorial content generation',
  100,
  1500,
  0.7

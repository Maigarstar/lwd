...
export const VENUES = [
  { id:1,  name:"Villa Rosanova",            region:"Tuscany",      city:"San Casciano",
    ...
    featured:true, verified:true, lwdScore:94, tag:"Estate of the Month",
  ...
  { id:2,  name:"Palazzo Vendramin",         region:"Veneto",       city:"Venice",
    ...
    featured:true, verified:true, lwdScore:97, tag:"Most Romantic",
  ...
  { id:3,  name:"Villa d'Este Estate",       region:"Lombardy",     city:"Cernobbio",
    ...
    featured:true, verified:true, lwdScore:96, tag:"Editor's Choice",
  ...
  { id:4,  name:"Masseria Torre Coccaro",    region:"Puglia",       city:"Fasano",
    ...
    featured:false, verified:true, lwdScore:88, tag:"Top Rated",
  ...
  { id:5,  name:"Ravello Cliffside Estate",  region:"Campania",     city:"Ravello",
    ...
    featured:true, verified:true, lwdScore:91, tag:"Destination Pick",

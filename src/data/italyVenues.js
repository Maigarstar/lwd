...
export const VENUES = [
  { id:1,  name:"Villa Rosanova",            region:"Tuscany",      city:"San Casciano",
    ...
    featured:true, verified:true, lwdScore:94, contentQualityScore:94, tag:"Estate of the Month",
  ...
  { id:2,  name:"Palazzo Vendramin",         region:"Veneto",       city:"Venice",
    ...
    featured:true, verified:true, lwdScore:97, contentQualityScore:97, tag:"Most Romantic",
  ...
  { id:3,  name:"Villa d'Este Estate",       region:"Lombardy",     city:"Cernobbio",
    ...
    featured:true, verified:true, lwdScore:96, contentQualityScore:96, tag:"Editor's Choice",

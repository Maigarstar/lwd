...
function skeletonRegion(slug, name, countrySlug, group, relatedRegionSlugs = []) {
  const canonicalPrefix = countrySlug === "ireland" ? "/ireland" : "/uk";
  return {
    slug,
    name,
    countrySlug,
...
const UK_IRELAND_SKELETON_REGIONS = [
  // England
  skeletonRegion("kent", "Kent", "uk", "England", ["london", "surrey", "sussex"]),
  skeletonRegion("sussex", "Sussex", "uk", "England", ["surrey", "kent", "hampshire"]),
  skeletonRegion("hampshire", "Hampshire", "uk", "England", ["surrey", "dorset", "wiltshire"]),
  skeletonRegion("berkshire", "Berkshire", "uk", "England", ["surrey", "oxfordshire", "buckinghamshire"]),
  skeletonRegion("buckinghamshire", "Buckinghamshire", "uk", "England", ["berkshire", "oxfordshire", "hertfordshire"]),
  skeletonRegion("oxfordshire", "Oxfordshire", "uk", "England", ["berkshire", "buckinghamshire", "gloucestershire"]),
  skeletonRegion("essex", "Essex", "uk", "England", ["london", "hertfordshire", "suffolk"]),
  skeletonRegion("hertfordshire", "Hertfordshire", "uk", "England", ["london", "essex", "buckinghamshire"]),
  skeletonRegion("devon", "Devon", "uk", "England", ["cornwall", "somerset", "dorset"]),
  skeletonRegion("cornwall", "Cornwall", "uk", "England", ["devon"]),
  skeletonRegion("somerset", "Somerset", "uk", "England", ["devon", "dorset", "wiltshire"]),
  skeletonRegion("dorset", "Dorset", "uk", "England", ["hampshire", "somerset", "wiltshire"]),
  skeletonRegion("wiltshire", "Wiltshire", "uk", "England", ["hampshire", "dorset", "gloucestershire"]),
  skeletonRegion("gloucestershire", "Gloucestershire", "uk", "England", ["oxfordshire", "wiltshire", "bristol"]),
  skeletonRegion("suffolk", "Suffolk", "uk", "England", ["essex", "norfolk", "cambridgeshire"]),
  skeletonRegion("norfolk", "Norfolk", "uk", "England", ["suffolk", "cambridgeshire"]),
  skeletonRegion("cambridgeshire", "Cambridgeshire", "uk", "England", ["suffolk", "norfolk", "hertfordshire"]),
  skeletonRegion("bristol", "Bristol", "uk", "England", ["gloucestershire", "somerset"]),
  skeletonRegion("warwickshire", "Warwickshire", "uk", "England", ["staffordshire", "leicestershire", "oxfordshire"]),
  skeletonRegion("staffordshire", "Staffordshire", "uk", "England", ["cheshire", "derbyshire", "warwickshire"]),
  skeletonRegion("cheshire", "Cheshire", "uk", "England", ["manchester", "staffordshire", "shropshire"]),
  skeletonRegion("manchester", "Manchester", "uk", "England", ["cheshire", "lancashire", "derbyshire"]),
  skeletonRegion("lancashire", "Lancashire", "uk", "England", ["manchester", "cumbria", "yorkshire"]),
  skeletonRegion("derbyshire", "Derbyshire", "uk", "England", ["staffordshire", "nottinghamshire", "leicestershire"]),
  skeletonRegion("leicestershire", "Leicestershire", "uk", "England", ["warwickshire", "derbyshire", "nottinghamshire"]),
  skeletonRegion("nottinghamshire", "Nottinghamshire", "uk", "England", ["derbyshire", "leicestershire", "yorkshire"]),
  skeletonRegion("shropshire", "Shropshire", "uk", "England", ["cheshire", "staffordshire"]),
  skeletonRegion("liverpool", "Liverpool", "uk", "England", ["cheshire", "lancashire", "manchester"]),
  skeletonRegion("yorkshire", "Yorkshire", "uk", "England", ["lancashire", "derbyshire", "durham"]),
  skeletonRegion("northumberland", "Northumberland", "uk", "England", ["durham", "cumbria"]),
  skeletonRegion("durham", "Durham", "uk", "England", ["northumberland", "yorkshire", "cumbria"]),
  skeletonRegion("cumbria", "Cumbria", "uk", "England", ["lancashire", "northumberland", "durham"]),

  // Scotland
  skeletonRegion("highlands", "Highlands", "uk", "Scotland", ["edinburgh"]),

  // Wales
  skeletonRegion("pembrokeshire", "Pembrokeshire", "uk", "Wales", ["cardiff"]),

  // Northern Ireland
  skeletonRegion("belfast", "Belfast", "uk", "Northern Ireland", []),
];

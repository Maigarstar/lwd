...
const REGION_CATEGORY_EDITORIALS = {
  ...
  "tuscany--wedding-planners":
    "Tuscany's wedding planning studios represent the pinnacle of Italian wedding expertise, drawing on centuries of cultural sophistication and unrivalled vendor relationships throughout the region. From Florence's design-forward planners orchestrating Renaissance villa celebrations to Siena-based specialists in intimate countryside weddings, Tuscany's planners excel at transforming rolling vineyard landscapes into intimate celebrations of extraordinary beauty. These planners navigate the complexities of international destination weddings with effortless grace, from Italian legal requirements and bilingual coordination to sourcing the region's finest wines and connecting with centuries-old artisan families. Many work exclusively through referral, bringing editorial-quality design sensibility to every detail from hand-calligraphed invitations to bespoke menus featuring Chianti wines and black truffle tastings. LWD's curated Tuscan planners are selected for their deep regional knowledge, creative vision, and consistent excellence in orchestrating celebrations of international calibre.",

  "sicily--wedding-planners":
    "Sicily's wedding planners blend Mediterranean luxury with the island's rich cultural heritage, creating celebrations that honour ancient traditions while delivering contemporary sophistication. From Palermo-based studios orchestrating opulent palazzo celebrations to Ragusa specialists in baroque town weddings and Mondello beach ceremonies, Sicily's planners excel at weaving the island's story into every celebration. These planners possess unparalleled knowledge of Sicily's most exclusive private estates, historic convents offering ceremony and reception spaces, and centuries-old artisan families — from embroiderers creating bespoke linens to pasta makers crafting custom wedding menus. Many speak multiple languages and work regularly with international couples, bringing both Italian warmth and professional precision to complex multi-day affairs. LWD's curated Sicilian planners are selected for their deep island knowledge, cultural sensitivity, creative vision, and the ability to deliver flawlessly at every scale.",

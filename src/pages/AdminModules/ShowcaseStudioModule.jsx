...
export default function ShowcaseStudioModule({ C, showcaseId, onBack }) {
  ...
  const btnSolid = { fontFamily: NU, fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '7px 16px', background: C.off, color: C.white, border: 'none', borderRadius: 3, cursor: 'pointer' };

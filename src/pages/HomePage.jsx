  ...
  return (
      <div style={{ background: C.black, minHeight: "100vh" }}>
        ...
        <main>
          ...
          <section style={{ background: "#000000", padding: "80px clamp(20px, 5vw, 64px)" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto" }}>

              {/* Section label */}
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 20 }}>
                <div style={{ width: 28, height: 1, background: "#C9A84C" }} />
                <span style={{ fontFamily: NU, fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", color: "#C9A84C", fontWeight: 600 }}>Explore</span>
                <div style={{ width: 28, height: 1, background: "#C9A84C" }} />
              </div>

              {/* Section heading */}
              <h2 style={{ fontFamily: GD, fontSize: "clamp(24px, 2.8vw, 34px)", fontWeight: 400, color: "#f5f0e8", lineHeight: 1.2, margin: "0 0 48px", textAlign: "center" }}>
                Begin your search
              </h2>
              ...
              <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.15fr 0.85fr", gap: 2, borderRadius: 4, overflow: "hidden", alignItems: "stretch" }}>
                ...
                <div style={{
                  ...
                  <div style={{ marginBottom: 28 }}>
                    <p style={{ fontFamily: NU, fontSize: 9, letterSpacing: "0.28em", color: "rgba(201,168,76,0.5)", textTransform: "uppercase", margin: "0 0 12px" }}>
                      Direct Browse
                    </p>
                    <h3 style={{ fontFamily: GD, fontSize: "clamp(22px, 2.5vw, 32px)", fontWeight: 400, color: "#f5f0e8", lineHeight: 1.15, margin: 0, letterSpacing: "-0.015em" }}>
                      Browse by<br />
                    ...
                    {VENDOR_CATEGORIES.slice(0, 12).map((cat) => {
                      ...
                      return (
                        <button
                          ...
                          style={{
                            background:     hov ? "rgba(201,168,76,0.08)" : "rgba(255,255,255,0.03)",
                            ...
                            color:          hov ? "#f5f0e8" : "rgba(245,240,232,0.65)",
                            whiteSpace:     "nowrap",
                            overflow:       "hidden",
                  ...
                  {/* Footer hint */}
                  <p style={{ fontFamily: NU, fontSize: 11, color: "rgba(255,255,255,0.2)", margin: "24px 0 0", letterSpacing: "0.03em" }}>

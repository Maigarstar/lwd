...
export default function CategorySliderSection({ section, onChange, C, NU }) {
    ...
    <div style={{ backgroundColor: C.card, borderRadius: 4, padding: 12, display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div>
        ...
        <input
          ...
          placeholder="Browse by Service Type"
          style={{
            width: '100%',
            padding: '8px 10px',
            fontFamily: NU,
      ...
      <p style={{ fontFamily: NU, fontSize: 11, color: C.grey2, margin: 0 }}>
        Scrollable horizontal category slider with 16 service categories.
      </p>
    </div>
  );
}

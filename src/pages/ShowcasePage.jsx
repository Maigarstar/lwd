...
//
// Route:  /showcase/[slug]  e.g. /showcase/grand-tirolia-kitzbuehel
// ─────────────────────────────────────────────────────────────────────────────
...
// ─── BreadcrumbBar ────────────────────────────────────────────────────────────
// Renders: Home › Destinations › Austria › Grand Tirolia
// URL stays /showcase/[slug] — country comes from venue.location.country
    ...
    <div style={{
      ...
      {crumbs.map((crumb, i) => (
        <span key={i} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          {crumb.current ? (
            <span style={{
              fontFamily: NU, fontSize: 11, color: C.text,

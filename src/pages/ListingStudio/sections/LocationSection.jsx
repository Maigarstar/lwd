...
const REGIONS_BY_COUNTRY = {
  ...
  // ── UK split by constituent countries (matching countryRegistry.js) ───
  england: [
    'Bedfordshire', 'Berkshire', 'Birmingham & West Midlands', 'Bristol & Somerset',
    'Buckinghamshire', 'Cambridge & East Anglia', 'Cheshire', 'Cornwall',
    'Cotswolds', 'Cumbria', 'Derbyshire', 'Devon', 'Dorset', 'Durham',
    'Essex', 'Exeter', 'Gloucestershire', 'Hampshire', 'Herefordshire',
    'Hertfordshire', 'Isle of Wight', 'Kent', 'Lake District', 'Lancashire',
    'Leicestershire', 'Lincolnshire', 'London', 'Manchester & Greater Manchester',
    'Merseyside', 'Milton Keynes', 'Norfolk', 'Northamptonshire', 'Northumberland',
    'Nottinghamshire', 'Oxfordshire', 'Peak District', 'Plymouth & South Devon',
    'Reading & Berkshire', 'Rutland', 'Shropshire', 'Somerset', 'South Downs',
    'Southampton & Hampshire', 'Southend & Essex Coast', 'Staffordshire',
    'Stoke-on-Trent', 'Suffolk', 'Surrey', 'Sussex', 'Swindon & Wiltshire',
    'Torquay & Devon Coast', 'Warwickshire', 'Westmorland', 'Weston-super-Mare',
    'Wiltshire', 'Worcestershire', 'Yorkshire', 'Yorkshire Dales',
  ],
  scotland: [
    'Aberdeen & Grampian', 'Angus', 'Argyll & Bute', 'Ayrshire',
    'Borders', 'Central Belt', 'Clyde Valley', 'Dumfries & Galloway',
    'Dunfermline & Fife', 'Edinburgh & Lothians', 'Falkirk', 'Fife',
    'Glasgow & Lanarkshire', 'Grampian', 'Highlands', 'Inverness & Highlands',
    'Isle of Skye', 'Moray', 'Outer Hebrides', 'Perth & Kinross',
    'Perthshire', 'Scottish Borders', 'Scottish Central Belt', 'Scottish Highlands',
    'Shetland Islands', 'Stirling & Clackmannanshire', 'Strathclyde', 'Tayside',
    'The Trossachs', 'Tyne & Wear Area',
  ],
  wales: [
    'Anglesey', 'Blaenau Gwent', 'Bridgend', 'Caerphilly', 'Cardiff',
    'Cardigan & Ceredigion', 'Carmarthen & Carmarthenshire', 'Ceredigion',
    'Chepstow & Monmouth', 'Conwy', 'Denbighshire', 'Denbigh',
    'Denbighshire', 'Dyfed', 'Ebbw Vale', 'Flintshire', 'Glamorgan',
    'Gwynedd', 'Merthyr Tydfil', 'Monmouth & Wye Valley', 'Monmouthshire',
    'Neath & Port Talbot', 'Newport', 'Newtown & Powys', 'North Wales',
    'Pembroke & Pembrokeshire', 'Pembrokeshire', 'Pontypool', 'Powys',
    'Prestatyn', 'Rhondda Cynon Taff', 'Snowdonia', 'South Wales', 'Swansea',
    'Tenby & South Pembrokeshire', 'Torfaen', 'Vale of Glamorgan', 'Wrexham',
  ],
  ireland: [
    'Antrim', 'Armagh', 'Carlow', 'Cavan', 'Clare', 'Cork',
    'Derry', 'Donegal', 'Down', 'Dublin', 'Fermanagh', 'Galway',
    'Kerry', 'Kildare', 'Kilkenny', 'Laois', 'Leitrim', 'Limerick',
    'Londonderry', 'Longford', 'Louth', 'Mayo', 'Meath', 'Monaghan',
    'Offaly', 'Roscommon', 'Sligo', 'Tipperary', 'Tyrone', 'Waterford',
    'Westmeath', 'Wexford', 'Wicklow',
  ],
  // ── Legacy `uk` key for backwards compatibility ───
  uk: [

...
export default function RegionPage({
  ...
  return (
      <div style={{ background: C.black, minHeight: "100vh", color: C.white }}>
        ...
        {/* ═══ EDITORIAL SECTION — Unified Aura Bridge ════════════════════════════ */}
        <section
          style={{
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              ...
              >
                {region.name} has long been one of the world's most sought-after settings for destination weddings, where dramatic landscapes, timeless architecture, and unparalleled beauty create an atmosphere unlike anywhere else.
              </p>

...
const SECTION_SCHEMAS = {
  ...
  'map':            `{"headline":"Location of your stay","addressHeading":"Hotel Address","addressDisplay":"","checkin":"15:00","checkout":"12:00","what3words":"","whereHeading":"Where is it?","whereItems":[{"text":""},{"text":""}],"zoom":14} — Fill addressDisplay with the full formatted hotel address (multiline: name, street, city, postcode, country). Fill checkin/checkout with times. Fill what3words if known (format: ///word.word.word). Fill whereItems with 2–4 distance items (e.g. "5 mins to city centre by taxi", "12 km to international airport"). Leave lat/lng empty — resolved automatically.`,

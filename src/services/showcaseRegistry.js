...
export const SECTION_REGISTRY = {
  ...
  map: {
    ...
    icon:      '◎',
    required:  [],
    optional:  ['headline', 'addressDisplay', 'addressHeading', 'checkin', 'checkout', 'what3words', 'whereHeading', 'whereItems', 'lat', 'lng', 'zoom'],
    defaultContent: () => ({
      headline:       'Location of your stay',
      addressHeading: 'Hotel Address',
      addressDisplay: '',
      checkin:        '',
      checkout:       '',
      what3words:     '',
      whereHeading:   'Where is it?',
      whereItems:     [],
      lat:            '',
      lng:            '',
      zoom:           14,

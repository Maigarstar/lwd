// ─── src/components/sections/CategoryEditorial.jsx ───────────────────────────
// Editorial strip layout — cream background, full-width rows, very luxury.
// Each category = a horizontal strip with index number + name + image.
// On hover: strip goes dark, text inverts, image reveals.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function CategoryEditorial({ locationName, onSelect } = {}) {
  return (
    <section

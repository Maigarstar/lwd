// ─── src/components/cards/VenueHCard.jsx ──────────────────────────────────────
// Horizontal venue card for list view — shows price, capacity, address
...
export default function VenueHCard({ v, saved, onSave, onView, onQuickView }) {
  const C = useTheme();
